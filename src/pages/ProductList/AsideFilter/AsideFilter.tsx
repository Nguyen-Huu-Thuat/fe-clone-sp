...
export default function AsideFilter() {
  return (
    <div className='py-4'>
      <Link to='/home' className='flex items-center font-bold capitalize'>
      ...
      <ul>
        <li className='py-2 pl-2'>
          <Link to='#' className='relative px-2 text-orange font-bold'>
          ...
          <li className='py-1 pl-2'>
            <Link to='#' className='flex items-center text-sm gap-1'>
              {Array(5)
                .fill(0)
                .map((_, index) => (
                  <svg viewBox='0 0 9.5 8' className='w-4 h-4 fill-current' key={index}>
                    <defs>
              ...
              <span className='pl-1'>trở lên</span>
            </Link>
          </li>
        </ul>
      </div>
      <div className='bg-gray-300 h-[1px] my-4' />
      <Button className='bg-orange w-full p-2 uppercase hover:bg-orange/80 text-white text-sm'>Xoá tất cả</Button>
    </div>
  )
}
